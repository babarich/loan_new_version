    ...
    <div class="row mb-6 mt-4">
        ...
        <div class="col-sm-12 col-md-6 col-lg-6">
            <div class="d-flex flex-row-reverse">
                  <a class="btn btn-primary" href="{{route('collateraltype.create')}}"><i class="bx bx-plus"></i> Add New type</a>
            </div>
        </div>
    </div>
                               ...
                               <tr>
                                ...
                                @foreach($types as $type)
                                    <tr>
                                       ...
                                       <td>
                                            <a href="{{route('collateraltype.edit', $type->id)}}" class="btn btn-sm btn-primary btn-wave waves-effect waves-light">
                                                <i class="ri-pencil-line align-middle me-2 d-inline-block"></i>Edit
                                            </a>
                                            <a href="{{route('collateraltype.show', $type->id)}}" class="btn btn-sm btn-success btn-wave waves-effect waves-light">
