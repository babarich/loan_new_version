            ...
            <div class="col-sm-12 col-md-6 col-lg-6">
                <div class="d-flex flex-row-reverse">
                    @if($loan->release_status = 'approved')
                        <a class="btn btn-success" data-bs-toggle="modal" data-bs-target="#settlement"><i class="bx bx-check"></i> RollOver </a>
                    @endif
            ...
            <div class="modal-dialog modal-dialog-top">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title" id="staticBackdropLabel">Perform Loan Rollover
                        </h6>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                    </div>
                    <form action="{{route('loan.rolloverPayment', $loan->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">

                            <div class="col-xl-12 mb-3">
                                <label for="create-folder1" class="form-label"> Rollover Date</label>
                                <input  class="form-control" type="date" name="date" required value="{{date('Y-m-d', strtotime($schedule->due_date))}}" readonly>
                            </div>
                            <div class="col-xl-12 mb-3">
                                <label for="create-folder1" class="form-label">  Rollover Amount</label>
                                <input  class="form-control  number-format" type="number" name="amount" id="amount" value="{{$schedule->interest}}"
                                        required readonly>
                            </div>
                            <div class="col-xl-12 mb-3">
