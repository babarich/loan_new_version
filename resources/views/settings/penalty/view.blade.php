                                ...
                                <ul class="list-group" style="width: 100%">
                                    <li class="list-group-item">
                                        <div class="d-flex flex-wrap gap-2 align-items-center">
                                            ...
                                            <span class="fs-12 text-muted float-end">{{$penalty->name}}</span>
                                        </div>
                                    </li>
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex flex-wrap gap-2 align-items-center">
                                            ...
                                            <span class="fs-12 text-muted float-end">{{$penalty->percent}}</span>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="d-flex flex-wrap gap-2 align-items-center">
                                            ...
                                            <span class="fs-12 text-muted float-end">{{$penalty->period}}</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
