                    ...
                    <div class="card-body">
                        <div class="row gy-4 mb-4">
                            <div class="col-xl-12">
                                ...
                                <input type="text" class="form-control" id="name" placeholder="" name="name" value="{{old('name', $group->name)}}">
                                @error('name')
                            ...
                            <div class="col-xl-12">
                                ...
                                <textarea type="text" class="form-control" id="description" placeholder="" name="description">{{old('description', $group->description)}}</textarea>
                                @error('description')
                                <span class="text-danger"><strong>{{$message}}</strong></span>
                                @enderror
                            </div>
